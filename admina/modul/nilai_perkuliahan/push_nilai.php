...
//$token = 'acdbbc82c3b29f99e9096dab1d5eafb4';
	...
	'nilai_huruf' => $value->nilai_huruf,
			...
			++$error_count;
			$error_msg[] = "Pastikan $nim Sudah melakukan KRS Pada Matkul $nama_mk Kelas $kelas";
			$db->update('nilai',array('status_error' => 2, 'keterangan'=>"Pastikan $nim Sudah melakukan KRS Pada Matkul $nama_mk Kelas $kelas"),'id',$value->id_krs);
		}
