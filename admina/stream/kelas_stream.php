...
$data = file_get_contents('http://simak.uinsgd.ac.id/gtakademik/services/my_service/feeder_kelas.php?prodi='.$_GET['jurusan'].'&semester='.$_GET['sem']);
...
if (($sukses>0) || ($error_count>0)) {
	$msg =  "<div class=\"alert alert-warning\" role=\"alert\">
			<font color=\"#3c763d\">".$sukses." data Kelas baru berhasil Diunduh</font><br />
